...
const CATS_DEF=[
 ...
 {k:'parabolas',n:'Parábolas',ic:'🌱',modo:'turno',tipo:'qa',color:'#22C55E',orden:'azar',activa:true},
 {k:'milagros',n:'Milagros de Jesús',ic:'✨',modo:'turno',tipo:'qa',color:'#FACC15',orden:'azar',activa:true},
 {k:'reyes',n:'Reyes de Israel',ic:'👑',modo:'turno',tipo:'qa',color:'#6366F1',orden:'azar',activa:true},
 {k:'cartas',n:'Cartas de Pablo',ic:'✍️',modo:'turno',tipo:'qa',color:'#D946EF',orden:'azar',activa:true},
 {k:'profecias',n:'Profecías',ic:'🔥',modo:'turno',tipo:'qa',color:'#78350F',orden:'azar',activa:true}
];
const BANCO_DEF={
hombres:[
...
parabolas:[
 {q:'En la parábola del sembrador, ¿qué representa la semilla?',a:'La palabra de Dios',r:'Lucas 8:11'},
 {q:'¿Cuántos tipos de terreno hay en la parábola del sembrador?',a:'Cuatro',r:'Lucas 8:5-8'},
 {q:'En la parábola del buen samaritano, ¿quiénes pasaron de largo antes de que el samaritano ayudara?',a:'Un sacerdote y un levita',r:'Lucas 10:31-32'},
 {q:'¿Qué hizo el buen samaritano por el hombre herido?',a:'Vendó sus heridas, lo llevó a un mesón y pagó por su cuidado',r:'Lucas 10:34-35'},
 {q:'En la parábola del hijo pródigo, ¿qué pidió el hijo menor a su padre?',a:'Su parte de la herencia',r:'Lucas 15:12'},
 {q:'¿Qué hizo el padre cuando vio regresar a su hijo pródigo?',a:'Corrió, se echó sobre su cuello y lo besó',r:'Lucas 15:20'},
 {q:'¿Qué mandó preparar el padre para celebrar el regreso de su hijo?',a:'El becerro gordo',r:'Lucas 15:23'},
 {q:'¿Quién se enojó porque su hermano menor fue recibido con fiesta?',a:'El hermano mayor',r:'Lucas 15:28'},
 {q:'¿Con qué comparó Jesús el reino de los cielos que crece de la semilla más pequeña?',a:'Con un grano de mostaza',r:'Mateo 13:31-32'},
 {q:'¿Con qué comparó Jesús el reino de los cielos que una mujer escondió en tres medidas de harina?',a:'Con la levadura',r:'Mateo 13:33'},
 {q:'¿Qué encontró el hombre que vendió todo lo que tenía para comprar un campo?',a:'Un tesoro escondido',r:'Mateo 13:44'},
 {q:'¿Qué buscaba el mercader que vendió todo lo que tenía?',a:'Una perla de gran precio',r:'Mateo 13:45-46'},
 {q:'En la parábola de la oveja perdida, ¿cuántas ovejas tenía el pastor?',a:'Cien',r:'Lucas 15:4'},
 {q:'¿Qué hizo la mujer que perdió una moneda hasta hallarla?',a:'Barrió la casa y buscó con diligencia',r:'Lucas 15:8'},
 {q:'En la parábola de los talentos, ¿cuántos talentos recibió el primer siervo?',a:'Cinco',r:'Mateo 25:15'},
 {q:'¿Qué hizo el siervo que recibió un solo talento?',a:'Lo escondió en la tierra',r:'Mateo 25:18'},
 {q:'En la parábola de las diez vírgenes, ¿cuántas eran prudentes y cuántas insensatas?',a:'Cinco prudentes y cinco insensatas',r:'Mateo 25:2'},
 {q:'¿Qué les faltó a las vírgenes insensatas?',a:'Aceite para sus lámparas',r:'Mateo 25:3-4'},
 {q:'En la parábola del rico y Lázaro, ¿dónde se sentaba Lázaro?',a:'A la puerta del rico, cubierto de llagas',r:'Lucas 16:20'},
 {q:'¿A qué lugar fue llevado Lázaro después de morir?',a:'Al seno de Abraham',r:'Lucas 16:22'},
 {q:'En la parábola del fariseo y el publicano, ¿quién se fue justificado a su casa?',a:'El publicano',r:'Lucas 18:14'},
 {q:'¿Qué decía el fariseo en su oración sobre sí mismo?',a:'Que no era como los demás hombres: ladrones, injustos, adúlteros',r:'Lucas 18:11'},
 {q:'En la parábola de los labradores malvados, ¿qué hicieron con el hijo del dueño de la viña?',a:'Lo mataron y lo echaron fuera de la viña',r:'Mateo 21:39'},
 {q:'¿Sobre qué construyó su casa el hombre prudente?',a:'Sobre la roca',r:'Mateo 7:24-25'},
 {q:'¿Sobre qué construyó su casa el hombre insensato?',a:'Sobre la arena',r:'Mateo 7:26'},
 {q:'En la parábola del deudor malvado, ¿cuánto le perdonó el rey al siervo?',a:'Diez mil talentos',r:'Mateo 18:24'},
 {q:'¿Cuánto le debía a ese siervo su consiervo?',a:'Cien denarios',r:'Mateo 18:28'},
 {q:'En la parábola de los obreros de la viña, ¿cuánto pagó el dueño a todos los obreros?',a:'Un denario a cada uno',r:'Mateo 20:9-10'},
 {q:'En la parábola del gran banquete, ¿qué excusas dieron los invitados para no asistir?',a:'Un campo comprado, bueyes por probar y un reciente matrimonio',r:'Lucas 14:18-20'},
 {q:'¿A quiénes mandó finalmente invitar el señor de la casa al banquete?',a:'A los pobres, los mancos, los cojos y los ciegos',r:'Lucas 14:21'}
],
milagros:[
 {q:'¿Cuál fue el primer milagro de Jesús?',a:'Convertir el agua en vino',r:'Juan 2:11'},
 {q:'¿En qué lugar convirtió Jesús el agua en vino?',a:'En Caná de Galilea',r:'Juan 2:1,11'},
 {q:'¿Cuántos panes y peces usó Jesús para alimentar a los cinco mil?',a:'Cinco panes y dos peces',r:'Mateo 14:17,19'},
 {q:'¿Cuántas canastas de sobras recogieron después de alimentar a los cinco mil?',a:'Doce canastas',r:'Mateo 14:20'},
 {q:'¿Sobre qué caminó Jesús para llegar a la barca de sus discípulos?',a:'Sobre el mar',r:'Mateo 14:25'},
 {q:'¿Qué dijo Jesús al mar embravecido para calmarlo?',a:'"Calla, enmudece"',r:'Marcos 4:39'},
 {q:'¿A qué familiar de Pedro sanó Jesús de una fiebre?',a:'A su suegra',r:'Mateo 8:14-15'},
 {q:'¿Cuántos días llevaba muerto Lázaro cuando Jesús lo resucitó?',a:'Cuatro días',r:'Juan 11:17'},
 {q:'¿Qué gritó Jesús frente a la tumba de Lázaro?',a:'"¡Lázaro, ven fuera!"',r:'Juan 11:43'},
 {q:'¿A qué niña de doce años resucitó Jesús?',a:'A la hija de Jairo',r:'Marcos 5:41-42'},
 {q:'¿Qué hizo Jesús, además de tocarlo, para sanar a un ciego en Betsaida?',a:'Puso saliva en sus ojos',r:'Marcos 8:23'},
 {q:'¿Con qué hizo Jesús lodo para sanar a un ciego de nacimiento?',a:'Con tierra y su saliva',r:'Juan 9:6'},
 {q:'¿Dónde mandó Jesús lavarse al ciego de nacimiento?',a:'En el estanque de Siloé',r:'Juan 9:7'},
 {q:'¿Qué padecía el hombre al que cuatro amigos bajaron por el techo hasta Jesús?',a:'Estaba paralítico',r:'Marcos 2:3-5'},
 {q:'¿Qué le dijo Jesús a la mujer que padecía flujo de sangre doce años?',a:'"Hija, tu fe te ha hecho salva; ve en paz"',r:'Marcos 5:34'},
 {q:'¿Cuántos leprosos sanó Jesús camino a Jerusalén?',a:'Diez',r:'Lucas 17:12,14'},
 {q:'¿Cuántos de los diez leprosos volvieron a agradecerle?',a:'Uno',r:'Lucas 17:15-16'},
 {q:'¿Qué le pidió Jesús al hombre de la mano seca que hiciera?',a:'Que extendiera la mano',r:'Marcos 3:5'},
 {q:'¿En qué día de la semana sanó Jesús al hombre de la mano seca, causando polémica?',a:'En sábado',r:'Marcos 3:2-4'},
 {q:'¿Cuántos años llevaba enfermo el hombre junto al estanque de Betesda?',a:'Treinta y ocho años',r:'Juan 5:5'},
 {q:'¿Qué le preguntó Jesús a ese hombre antes de sanarlo?',a:'"¿Quieres ser sano?"',r:'Juan 5:6'},
 {q:'¿A qué endemoniado que vivía entre los sepulcros sanó Jesús?',a:'Al endemoniado gadareno',r:'Marcos 5:2-9'},
 {q:'¿En qué animales entraron los demonios que Jesús echó del gadareno?',a:'En una piara de cerdos',r:'Marcos 5:13'},
 {q:'¿Cuántos peces tomó la red en la pesca milagrosa que casi la rompe?',a:'Ciento cincuenta y tres',r:'Juan 21:11'},
 {q:'¿Qué encontró Pedro en la boca de un pez para pagar el tributo?',a:'Una moneda de plata',r:'Mateo 17:27'},
 {q:'¿A quién sanó Jesús la oreja que un discípulo le cortó, en Getsemaní?',a:'Al siervo del sumo sacerdote, Malco',r:'Lucas 22:50-51'},
 {q:'¿Qué le devolvió Jesús a la viuda de Naín?',a:'A su hijo, resucitándolo',r:'Lucas 7:14-15'},
 {q:'¿Dónde encontró Jesús el funeral del hijo de la viuda de Naín?',a:'A la puerta de la ciudad',r:'Lucas 7:12'},
 {q:'¿Qué le pidió a gritos el ciego Bartimeo a Jesús?',a:'"Ten misericordia de mí"',r:'Marcos 10:47'},
 {q:'¿Qué hizo Jesús con la higuera que no tenía fruto?',a:'La maldijo, y se secó',r:'Mateo 21:19'}
],
reyes:[
 {q:'¿Quién fue el primer rey de Israel?',a:'Saúl',r:'1 Samuel 10:1'},
 {q:'¿De qué tribu era Saúl?',a:'De Benjamín',r:'1 Samuel 9:1-2'},
 {q:'¿Quién ungió a Saúl como rey?',a:'El profeta Samuel',r:'1 Samuel 10:1'},
 {q:'¿Quién sucedió a Saúl como rey de Israel?',a:'David',r:'2 Samuel 2:4'},
 {q:'¿De qué tribu era David?',a:'De Judá',r:'1 Samuel 17:12'},
 {q:'¿En qué ciudad reinó David después de conquistarla?',a:'En Jerusalén',r:'2 Samuel 5:6-7'},
 {q:'¿Qué hijo de David lo sucedió como rey?',a:'Salomón',r:'1 Reyes 1:39'},
 {q:'¿Qué pidió Salomón a Dios al comenzar su reinado?',a:'Sabiduría para gobernar',r:'1 Reyes 3:9'},
 {q:'¿Qué construyó Salomón en Jerusalén?',a:'El templo de Jehová',r:'1 Reyes 6:1'},
 {q:'¿Quién visitó a Salomón para probarlo con preguntas difíciles?',a:'La reina de Sabá',r:'1 Reyes 10:1'},
 {q:'¿En qué dos reinos se dividió Israel después de Salomón?',a:'Israel, al norte, y Judá, al sur',r:'1 Reyes 12:19-20'},
 {q:'¿Quién fue el primer rey del reino del norte, Israel?',a:'Jeroboam',r:'1 Reyes 12:20'},
 {q:'¿Qué hijo de Salomón reinó sobre Judá tras la división del reino?',a:'Roboam',r:'1 Reyes 12:17'},
 {q:'¿Qué rey de Israel fue esposo de Jezabel?',a:'Acab',r:'1 Reyes 16:31'},
 {q:'¿Qué profeta enfrentó al rey Acab en el monte Carmelo?',a:'Elías',r:'1 Reyes 18:19'},
 {q:'¿Qué rey de Judá fue conocido por destruir los ídolos en una gran reforma religiosa?',a:'Josías',r:'2 Reyes 23:24-25'},
 {q:'¿Qué rey de Judá enfermó gravemente y pidió a Dios más años de vida?',a:'Ezequías',r:'2 Reyes 20:1-6'},
 {q:'¿Cuántos años de vida añadió Dios a Ezequías?',a:'Quince años',r:'2 Reyes 20:6'},
 {q:'¿Qué rey construyó un túnel para llevar agua a Jerusalén?',a:'Ezequías',r:'2 Reyes 20:20'},
 {q:'¿Qué rey de Judá fue muy malvado y sacrificó a su hijo en el fuego?',a:'Manasés',r:'2 Reyes 21:6'},
 {q:'¿Qué rey de Israel mató a toda la familia de Acab por mandato de Dios?',a:'Jehú',r:'2 Reyes 10:11'},
 {q:'¿Qué reina malvada gobernó Judá tras matar a sus propios nietos?',a:'Atalía',r:'2 Reyes 11:1'},
 {q:'¿Quién fue escondido de niño de la matanza de Atalía y luego coronado rey?',a:'Joás',r:'2 Reyes 11:2-4,12'},
 {q:'¿Qué imperio conquistó el reino del norte, Israel, y llevó a su pueblo cautivo?',a:'Asiria',r:'2 Reyes 17:6'},
 {q:'¿Qué imperio conquistó finalmente el reino de Judá y destruyó Jerusalén?',a:'Babilonia',r:'2 Reyes 25:8-9'},
 {q:'¿Qué rey de Judá fue llevado cautivo a Babilonia tras la caída de Jerusalén?',a:'Sedequías',r:'2 Reyes 25:7'},
 {q:'¿Qué rey de Judá se leprosó por su orgullo, al quemar incienso en el templo?',a:'Uzías',r:'2 Crónicas 26:19-21'},
 {q:'¿Qué rey de Israel construyó la ciudad de Samaria como su capital?',a:'Omri',r:'1 Reyes 16:24'},
 {q:'¿Cuántos años reinó David sobre Israel?',a:'Cuarenta años',r:'1 Reyes 2:11'},
 {q:'¿Cuántos años reinó Salomón sobre Israel?',a:'Cuarenta años',r:'1 Reyes 11:42'}
],
cartas:[
 {q:'¿En qué carta de Pablo aparece la frase "todos pecaron y están destituidos de la gloria de Dios"?',a:'En Romanos',r:'Romanos 3:23'},
 {q:'¿En qué carta de Pablo aparece el "himno al amor"?',a:'En 1 Corintios',r:'1 Corintios 13:1-13'},
 {q:'¿A qué ciudad correspondía la iglesia dividida en bandos que seguían a Pablo, Apolos y Cefas?',a:'Corinto',r:'1 Corintios 1:12'},
 {q:'¿En qué carta describe Pablo su "aguijón en la carne"?',a:'En 2 Corintios',r:'2 Corintios 12:7'},
 {q:'¿En qué carta defiende Pablo con fuerza la justificación por la fe y no por las obras de la ley?',a:'En Gálatas',r:'Gálatas 2:16'},
 {q:'¿Cómo llama Pablo a la lista de virtudes: amor, gozo, paz, paciencia…?',a:'El fruto del Espíritu',r:'Gálatas 5:22-23'},
 {q:'¿En qué carta se describe "la armadura de Dios"?',a:'En Efesios',r:'Efesios 6:11'},
 {q:'¿Desde dónde escribió Pablo la carta a los Filipenses?',a:'Desde la prisión',r:'Filipenses 1:7,13'},
 {q:'¿Qué frase de gozo repite Pablo en Filipenses 4:4?',a:'"Regocijaos en el Señor siempre"',r:'Filipenses 4:4'},
 {q:'¿En qué carta enseña Pablo que en Cristo "habita corporalmente toda la plenitud de la Deidad"?',a:'En Colosenses',r:'Colosenses 2:9'},
 {q:'¿En qué carta dice Pablo que "los muertos en Cristo resucitarán primero"?',a:'En 1 Tesalonicenses',r:'1 Tesalonicenses 4:16'},
 {q:'¿En qué carta advierte Pablo sobre el "hombre de pecado" antes del día del Señor?',a:'En 2 Tesalonicenses',r:'2 Tesalonicenses 2:3'},
 {q:'¿A qué joven pastor, hijo de madre judía y padre griego, escribió Pablo dos cartas pastorales?',a:'A Timoteo',r:'Hechos 16:1; 1 Timoteo 1:2'},
 {q:'¿En qué carta dice Pablo "toda la Escritura es inspirada por Dios"?',a:'En 2 Timoteo',r:'2 Timoteo 3:16'},
 {q:'¿En qué isla dejó Pablo a Tito para que ordenara ancianos en cada ciudad?',a:'En Creta',r:'Tito 1:5'},
 {q:'¿Por quién intercede Pablo ante Filemón?',a:'Por Onésimo, el esclavo fugitivo',r:'Filemón 1:10'},
 {q:'¿Qué le pide Pablo a Filemón que haga con Onésimo?',a:'Que lo reciba como a un hermano, no como esclavo',r:'Filemón 1:16'},
 {q:'¿Cuál es la carta más corta de Pablo, de un solo capítulo?',a:'Filemón',r:'Filemón 1:1-25'},
 {q:'¿En qué carta se llama Pablo a sí mismo "el primero" de los pecadores?',a:'En 1 Timoteo',r:'1 Timoteo 1:15'},
 {q:'¿Qué le pide Pablo a Timoteo que le lleve, junto con los libros y "principalmente los pergaminos"?',a:'El capote',r:'2 Timoteo 4:13'},
 {q:'¿En qué carta enumera Pablo los requisitos para ser obispo o anciano?',a:'En 1 Timoteo',r:'1 Timoteo 3:1-7'},
 {q:'¿En qué carta escribe Pablo "para mí el vivir es Cristo, y el morir es ganancia"?',a:'En Filipenses',r:'Filipenses 1:21'},
 {q:'¿En qué carta pide Pablo que también se lea la carta enviada a Laodicea?',a:'En Colosenses',r:'Colosenses 4:16'},
 {q:'¿Qué médico acompañaba a Pablo y es llamado "el médico amado"?',a:'Lucas',r:'Colosenses 4:14'},
 {q:'¿En qué carta aparece "a los que aman a Dios, todas las cosas les ayudan a bien"?',a:'En Romanos',r:'Romanos 8:28'},
 {q:'¿A qué iglesias fue dirigida la carta de Pablo que reprocha que se alejan tan pronto "del que os llamó"?',a:'A los gálatas',r:'Gálatas 1:2,6'},
 {q:'¿De qué ciudad huyó Pablo de noche, bajado en una canasta por el muro?',a:'De Damasco',r:'Hechos 9:25; 2 Corintios 11:32-33'},
 {q:'¿A qué dos mujeres pide Pablo que se reconcilien, en Filipenses 4:2?',a:'A Evodia y Síntique',r:'Filipenses 4:2'},
 {q:'¿Qué don espiritual llama Pablo superior porque edifica a la iglesia, en 1 Corintios 14?',a:'La profecía',r:'1 Corintios 14:1-4'},
 {q:'¿Cuántas cartas de Pablo hay en el Nuevo Testamento, de Romanos a Filemón?',a:'Trece',r:'Romanos–Filemón'}
],
profecias:[
 {q:'¿Qué profeta anunció que el Mesías nacería en Belén?',a:'Miqueas',r:'Miqueas 5:2'},
 {q:'¿Qué profeta anunció que una virgen concebiría y llamaría a su hijo Emanuel?',a:'Isaías',r:'Isaías 7:14'},
 {q:'¿Qué profeta describió al Mesías como "varón de dolores, experimentado en quebranto"?',a:'Isaías',r:'Isaías 53:3'},
 {q:'¿Qué profeta anunció que el Mesías sería vendido por treinta piezas de plata?',a:'Zacarías',r:'Zacarías 11:12-13'},
 {q:'¿Qué profeta vio una gran estatua que representaba reinos futuros, en un sueño de Nabucodonosor?',a:'Daniel',r:'Daniel 2:31-45'},
 {q:'¿Qué profeta interpretó la escritura en la pared: "Mene, Mene, Tekel, Uparsin"?',a:'Daniel',r:'Daniel 5:25-28'},
 {q:'¿Qué profeta fue llevado por el Espíritu a un valle lleno de huesos secos?',a:'Ezequiel',r:'Ezequiel 37:1'},
 {q:'¿Qué profeta vio ruedas dentro de ruedas y seres vivientes en su visión inicial?',a:'Ezequiel',r:'Ezequiel 1:15-16'},
 {q:'¿Qué profeta anunció setenta semanas para el pueblo de Daniel y su ciudad santa?',a:'Daniel',r:'Daniel 9:24'},
 {q:'¿Qué profeta predicó el arrepentimiento a Nínive y luego se enojó porque Dios los perdonó?',a:'Jonás',r:'Jonás 4:1'},
 {q:'¿Qué profeta anunció que Dios derramaría su Espíritu "sobre toda carne"?',a:'Joel',r:'Joel 2:28'},
 {q:'¿Qué apóstol citó la profecía de Joel el día de Pentecostés?',a:'Pedro',r:'Hechos 2:16-17'},
 {q:'¿Qué profeta anunció que Dios convertiría las espadas en rejas de arado?',a:'Isaías',r:'Isaías 2:4'},
 {q:'¿A qué profeta se le llama "el profeta llorón" por su llanto por Jerusalén?',a:'Jeremías',r:'Jeremías 9:1'},
 {q:'¿Qué profeta anunció el nuevo pacto que Dios escribiría en el corazón de su pueblo?',a:'Jeremías',r:'Jeremías 31:33'},
 {q:'¿Cuántos años de cautiverio en Babilonia anunció Jeremías?',a:'Setenta años',r:'Jeremías 25:11'},
 {q:'¿Qué profeta predijo la caída de Babilonia a manos de los medos?',a:'Isaías',r:'Isaías 13:17-19'},
 {q:'¿Qué profeta anunció por nombre que Ciro sería el instrumento de Dios para reconstruir Jerusalén?',a:'Isaías',r:'Isaías 44:28'},
 {q:'¿Qué profeta anunció que el Señor "se gozará sobre ti con cánticos"?',a:'Sofonías',r:'Sofonías 3:17'},
 {q:'¿Qué profeta vio al Señor sentado en un trono alto y sublime, y dijo "heme aquí, envíame a mí"?',a:'Isaías',r:'Isaías 6:1,8'},
 {q:'¿Qué tocó los labios de Isaías en su visión de llamado?',a:'Un carbón encendido tomado del altar',r:'Isaías 6:6-7'},
 {q:'¿Qué profeta comió un rollo que sabía dulce como la miel?',a:'Ezequiel',r:'Ezequiel 3:1-3'},
 {q:'¿Qué profeta se casó con una mujer infiel como señal profética de la infidelidad de Israel?',a:'Oseas',r:'Oseas 1:2-3'},
 {q:'¿Qué profeta anunció una plaga de langostas como juicio de Dios?',a:'Joel',r:'Joel 1:4'},
 {q:'¿Qué profeta acusó a Israel de injusticia diciendo "corra el juicio como las aguas"?',a:'Amós',r:'Amós 5:24'},
 {q:'¿Qué oficio tenía Amós antes de ser llamado profeta?',a:'Era pastor de ovejas y cultivador de higos silvestres',r:'Amós 7:14-15'},
 {q:'¿Qué profeta anunció que Dios enviaría un mensajero para preparar el camino del Señor?',a:'Malaquías',r:'Malaquías 3:1'},
 {q:'¿A quién identificó Jesús con "el espíritu de Elías" que vendría antes del gran día del Señor?',a:'A Juan el Bautista',r:'Mateo 11:13-14; Malaquías 4:5'},
 {q:'¿Qué profeta anunció el juicio contra Edom en un libro de un solo capítulo?',a:'Abdías',r:'Abdías 1:1-4'},
 {q:'¿Qué libro profético del Nuevo Testamento describe visiones del fin de los tiempos dadas al apóstol Juan?',a:'Apocalipsis',r:'Apocalipsis 1:1'}
]
};
